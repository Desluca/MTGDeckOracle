...
const EXTERNAL_TAG_ALIASES = new Map<string, FunctionalTag>([
  ...
  ["artifacts", "artifact_synergy"],
  ["artifact synergy", "artifact_synergy"],
  ["auras", "equipment_synergy"],
  ...
  ["draw", "card_draw"],
  ["counters", "counters_synergy"],
  ["enchantress", "enchantment_synergy"],
  ["enchantments", "enchantment_synergy"],
  ["equipment", "equipment_synergy"],
  ["engine", "value_engine"],
  ["fast mana", "fast_mana"],
  ...
  ["tokens", "token_synergy"],
  ["token", "token_synergy"],
  ["tribal", "tribal_synergy"],
  ["voltron", "equipment_synergy"],
  ["stax", "stax"],
  ["tutor", "tutor"],
  ["tutors", "tutor"],
  ["value", "value_engine"],
