...
- Parsing di liste testuali (quantita', `1x`, set/collector number, sezioni tipo `// COMMANDER`, carte doppia faccia `Nome / Altro Nome`). Lista da 100 carte senza sezione Commander: la prima carta e' il comandante.
